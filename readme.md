...
ℹ️ About Page explaining the mission and goals.
💻 Fully Responsive Design for desktop and mobile.
🎨 Attractive Medical-Themed UI with clean styling and animations.
🛠️ Tech Stack
...
git clone https://github.com/jindalharry07/Life-Line-24x7.git
Navigate to the project folder: cd Life-Line-24x7
Open mainpage/index.html in your browser to explore the app.

🔮 Future Scope 🌐 Location-based donor/ambulance tracking using Google Maps API

🔐 Login/signup system for patients and donors

🧾 Backend integration with database (e.g. Firebase or MongoDB)
